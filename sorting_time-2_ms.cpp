...
// Các hàm sắp xếp và khởi tạo dãy số đã được định nghĩa ở trên, ta không lặp lại ở đây để tránh lặp code.
...
int main() {
    ...
    for (int n : arr_sizes) {
        ...
        cout << "Selection Sort with n = " << n << " took: " << elapsed_time.count() << " ms" << endl;
        ...
        cout << "Insertion Sort with n = " << n << " took: " << elapsed_time.count() << " ms" << endl;
        ...
        end_time = chrono::high_resolution_clock::now();
        elapsed_time = end_time - start_time;
        cout << "Bubble Sort with n = " << n << " took: " << elapsed_time.count() << " ms" << endl;
        ...
        end_time = chrono::high_resolution_clock::now();
        elapsed_time = end_time - start_time;
        cout << "Quick Sort with n = " << n << " took: " << elapsed_time.count() << " ms" << endl;
        ...
        end_time = chrono::high_resolution_clock::now();
        elapsed_time = end_time - start_time;
        cout << "Merge Sort with n = " << n << " took: " << elapsed_time.count() << " ms" << endl;
